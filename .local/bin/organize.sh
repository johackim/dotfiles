...
mkdir -p textes
fd -j1 -d1 -esql -ertf -eodt -ejson -eyml -eyaml -exml -exls -etxt -eopml -epo -epdf -eepub -emobi -ecrt -edoc -edocx -exlsx -ehtml -ecsv -emd -etorrent -earia2 -ekey -esh -epy -eovpn -elog -econf -eods -exmind -egpx -edb -edrawio -eazw -eazw3 -eencrypted -eAppImage -ebin -em3u-etextes -x mv -n {} textes
